...
const HeaderDrawer = (props) => {
    ...
    return (
        <View
            ...
            <TouchableOpacity style={{  flexDirection: 'row', padding: wp('1%'), marginLeft: wp('3%'), borderRadius: 3 }}  onPress={() => props.navigation.navigate('Location')}>
                {/* <FontAwesome5 name='map-marker-alt'  size={hp('2%')} /> */}
                <Text style={{ fontWeight: 'bold', fontSize: hp('2%'),  marginLeft: wp('1%') }}>Sec 62 Noida</Text>
            </TouchableOpacity>
